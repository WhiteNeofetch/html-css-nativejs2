...
var accordion = function accordion(triggersSelector) {
  ...
  }); //css .often-questions .accordion-heading.active+.accordion-block
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusMessage.appendChild(statusImg); //loader in form

      var textMessage = document.createElement('div');
      textMessage.textContent = message.loading;
      statusMessage.appendChild(textMessage); //textmessage in form
...
var modals = function modals(modalState) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windows.forEach(function (item) {
          item.style.display = 'none';
          item.classList.add('animated', 'fadeIn'); //animate modals
        });
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); //old browsers
    ...
    const smoothScroll = (from, to, hash) =>{
      ...
      speed;
        ...
        let move = setInterval(function () {
          let scrollTop = Math.round(body.scrollTop || element.scrollTop);
            if (
              prevScrollTop === scrollTop || (to>from && scrollTop >= to) ||
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/styles') //getResource(assets/json.db)
    .then(function (res) {
